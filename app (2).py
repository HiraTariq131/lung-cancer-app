...
# Title
st.markdown("<h1>😽 Lung Cancer Predictor App</h1>", unsafe_allow_html=True)
st.markdown("<h1style='text-align: center;'>📝 Predict: Positive or Negative </h1><hr>", unsafe_allow_html=True)
